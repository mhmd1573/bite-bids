...
//   // ✅ NEW: Function to get full file URL
...
//     // Combine backend URL with file path
...
//                   <div className={`admin-message ${msg.sender_role}`}>
...
//                       {/* ✅ FIXED: Attachment with proper download handling */}
//                       {msg.file_url && (
