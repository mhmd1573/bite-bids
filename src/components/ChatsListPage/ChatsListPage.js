...
import React, { useState, useEffect } from 'react';
import { MessageCircle, Search, Clock, FolderOpen, User, Shield, AlertTriangle, ChevronDown, ChevronUp } from 'lucide-react';
import './ChatsListPage.css';
...
const ChatsListPage = ({ currentUser, navigateToChat }) => {
  ...
  return (
    <div className="chats-list-container">
      ...
      {/* Project Process Info Box - Collapsible */}
      <div style={{
        ...
        >
          ...
          {showProcessGuide ? (
            <ChevronUp size={20} style={{ color: '#0369a1' }} />
          ) : (
            <ChevronDown size={20} style={{ color: '#0369a1' }} />
          )}
        </div>
        {showProcessGuide && (
